...
class AuthIntegrationTest {
    ...
    void shouldRegisterLoginAndRefreshTokenSuccessfully() throws Exception {
        ...
        ApiResponse<AuthResponse> loginApiResponse = objectMapper.readValue(loginResponseBody, loginResponseType);
        ...
        ApiResponse<AuthResponse> refreshApiResponse = objectMapper.readValue(refreshResponseBody, refreshResponseType);
