...
public class FullOrderFlowIntegrationTest {
    ...
    void testFullOrderLifecycle() {
        ...
        PharmacyMedicationDTO stockAfterOrder = pharmacyMedicationService.getPharmacyMedication(pharmacy.getId(),
                medication.getId());
        assertEquals(10, stockAfterOrder.getStockQuantity());

        // --- Step 4: Process Payment ---
        PaymentRequestDTO paymentRequest = new PaymentRequestDTO(order.getId(), PaymentMethod.MTN_MOMO, "670000000");
