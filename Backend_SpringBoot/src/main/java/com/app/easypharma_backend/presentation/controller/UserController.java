...
public class UserController {
    ...
    @Operation(summary = "Récupère le profil de l'utilisateur connecté",
            description = "Permet à un utilisateur authentifié de récupérer ses propres informations de profil",
    ...
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<UserResponse>> getCurrentUser(
            @Parameter(description = "Jeton d'authentification Bearer", required = true)
        ...
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(response, "Profil utilisateur récupéré")
        );
    }
    ...
    @Operation(summary = "Met à jour le profil de l'utilisateur connecté",
            description = "Permet à un utilisateur authentifié de mettre à jour ses propres informations de profil",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<UserResponse>> updateCurrentUser(
            @Parameter(description = "Jeton d'authentification Bearer", required = true)
            @RequestHeader("Authorization") String authHeader,
            @Parameter(description = "Données de mise à jour de l'utilisateur", required = true)
        ...
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(response, "Profil utilisateur mis à jour")
        );
    }
    ...
    @Operation(summary = "Récupère un utilisateur par son ID",
            description = "Permet à un utilisateur authentifié de récupérer les informations d'un autre utilisateur par son identifiant",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<UserResponse>> getUserById(
            @Parameter(description = "Identifiant unique de l'utilisateur", required = true, example = "a1b2c3d4-e5f6-7890-abcd-ef1234567890")
            @PathVariable UUID id) {
        UserResponse response = getUserByIdUseCase.execute(id);
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(response, "Utilisateur récupéré")
        );
    }
     ...
     */
    @Operation(summary = "Supprime le compte de l'utilisateur connecté",
            description = "Permet à un utilisateur authentifié de supprimer définitivement son propre compte",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<Void>> deleteCurrentUser(
        ...
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(null, "Compte utilisateur supprimé")
        );
    }
    ...
    @Operation(summary = "Liste paginée des utilisateurs (ADMIN)",
            description = "Permet à un administrateur de récupérer la liste paginée de tous les utilisateurs",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "403",
                    description = "Accès interdit - Permissions administrateur requises"
            )
    })
    @GetMapping
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<PageResponse<UserResponse>>> getAllUsers(
        ...
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(response, "Liste des utilisateurs")
        );
    }
     ...
     */
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "Met à jour un utilisateur par ID (ADMIN)",
            description = "Permet à un administrateur de mettre à jour les informations d'un utilisateur spécifique par son identifiant",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<UserResponse>> updateUserById(
        ...
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(response, "Utilisateur mis à jour")
        );
    }
     ...
     */
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "Supprime un utilisateur par ID (ADMIN)",
            description = "Permet à un administrateur de supprimer définitivement un utilisateur spécifique par son identifiant",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<Void>> deleteUserById(
        ...
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(null, "Utilisateur supprimé")
        );
    }
     ...
     */
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "Change le rôle d'un utilisateur (ADMIN)",
            description = "Permet à un administrateur de modifier le rôle d'un utilisateur spécifique (ADMIN, PHARMACIST, CUSTOMER)",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
                    description = "Rôle utilisateur modifié avec succès",
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = UserResponse.class)
                    )
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "400",
                    description = "Requête invalide - Rôle spécifié incorrect"
            ),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "401",
                    description = "Non autorisé - Jeton invalide ou manquant"
    ...
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<UserResponse>> changeUserRole(
            @Parameter(description = "Identifiant unique de l'utilisateur", required = true, example = "a1b2c3d4-e5f6-7890-abcd-ef1234567890")
            @PathVariable UUID id,
            @Parameter(description = "Nouveau rôle à attribuer à l'utilisateur", required = true)
            @Valid @RequestBody ChangeUserRoleRequest request) {
        UserResponse response = changeUserRoleUseCase.execute(id, request.getRole());
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(response, "Rôle utilisateur modifié")
        );
    }
}