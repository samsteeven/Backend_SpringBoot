...
public class AuthController {
    ...
    @Operation(
            ...
            description = "Permet à un nouvel utilisateur de s'inscrire sur la plateforme"
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<AuthResponse>> register(
        ...
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(response, "Inscription réussie")
        );
    }
    ...
    @Operation(
            ...
            description = "Permet à un utilisateur de se connecter à la plateforme"
    )
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<AuthResponse>> login(
        ...
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(response, "Connexion réussie")
        );
    }
    ...
    @Operation(
            ...
            description = "Permet de rafraîchir le token d'accès avec le refresh token"
    )
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<AuthResponse>> refreshToken(
        ...
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(response, "Token rafraîchi avec succès")
        );
    }
    ...
    @Operation(
            summary = "Déconnexion",
            description = "Permet à un utilisateur de se déconnecter de la plateforme"
    )
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<Void>> logout(
        ...
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(null, "Déconnexion réussie")
        );
    }
    ...
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<Void>> forgotPassword(
        ...
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(null, "Instructions envoyées par email")
        );
    }
    ...
    public ResponseEntity<com.app.easypharma_backend.application.common.dto.ApiResponse<Void>> resetPassword(
        ...
        return ResponseEntity.ok(
                com.app.easypharma_backend.application.common.dto.ApiResponse.success(null, "Mot de passe réinitialisé avec succès")
        );
    }
    ...
    @Operation(
            ...
            description = "Permet à un utilisateur de récupérer ses informations de profil"
    )
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
